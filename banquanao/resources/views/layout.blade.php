					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								...
								<h4 class="panel-title"><a href="{{url('/danh-muc-sp/'.$cate->category_id)}}">{{$cate->category_name}}</a></h4>
								</div>
							</div>
							@endforeach
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								...
								<li><a href="{{url('/thuong-hieu-sp/'.$brand->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand->brand_name}}</a></li>
								</ul>
							</div>
							@endforeach
						</div><!--/brands_products-->
